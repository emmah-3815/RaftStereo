...
def gen_trajectory(start, goal, steps=50):
    ...
    combined = R.from_quat([start[3:], goal[3:]])
    ...
    return trajectory #x y z, qw, qx, qy, qz
...
def live_plot(thread, thread_upper, thread_lower, goal, trajectory):
    # set up plot
    fig = plt.figure()
...
if __name__ == "__main__":
    ...
    for goal in goals:
        ...
        live_plot(thread, upper, lower, goal, trajectory)
