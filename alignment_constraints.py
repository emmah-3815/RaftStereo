...
class ReconstructAlign:
    ...
    def grasp(self, pcd, thread, rely_above=0.3, dis_above=2, velo_below=1):
        ...
        reliability[reliability<rely_above] = False
        ...
        # pdb.set_trace()
        dis_rely = dis > dis_above
        candidates *= dis_rely

        # prune points too vertical
        z_velocity = points[1:, 2] - points[:-1, 2]
        z_velocity = np.append(z_velocity, velo_below) 
        ...
        velo_rely = z_velocity < velo_below
